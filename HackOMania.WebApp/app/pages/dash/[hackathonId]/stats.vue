  ...
  <UDashboardPanel id="participant-stats">
    ...
    <template #body>
      <div class="p-4 space-y-6 overflow-y-auto">
        <div
          v-if="isLoadingParticipants || isLoadingTeams"
        ...
        <template v-else>
          <UCard>
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
              <div
                v-for="card in registrationStats"
                :key="card.label"
            ...
            <div
              v-if="registrationCompletionRate !== null"
