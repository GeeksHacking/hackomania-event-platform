...
import { createGeeksHackingPortalApiEndpointsOrganizersStandaloneWorkshopsParticipantsParticipantResponse } from "./createGeeksHackingPortalApiEndpointsOrganizersStandaloneWorkshopsParticipantsParticipantResponse.ts";
...
export function createGeeksHackingPortalApiEndpointsOrganizersStandaloneWorkshopsParticipantsGetEndpoint200(data?: Partial<GeeksHackingPortalApiEndpointsOrganizersStandaloneWorkshopsParticipantsGetEndpoint200>): GeeksHackingPortalApiEndpointsOrganizersStandaloneWorkshopsParticipantsGetEndpoint200 {
  ...
  return createGeeksHackingPortalApiEndpointsOrganizersStandaloneWorkshopsParticipantsParticipantResponse(data)
}
